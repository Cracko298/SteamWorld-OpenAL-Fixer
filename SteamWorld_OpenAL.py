import os, re, winreg, platform, shutil, requests, time, urllib3, sys
...
def none_found_mode(game_path=None,os_type=64):
    if game_path == None:sys.exit(1)
    if "SteamWorld" not in game_path:print("Provided Game isn't a Valid SteamWorld Title.");sys.exit(1)
